...
export default function ReadingPracticePage() {
  ...
  }), [page, selectedDifficulty, selectedPassage, searchQuery]);
  ...
  const handleFilterChange = useCallback((type: 'difficulty' | 'passage', value: DifficultyLevel | number | null) => {
    if (type === 'difficulty') {
  ...
  const hasActiveFilters = selectedDifficulty || selectedPassage || searchQuery;
      ...
      <div className="bg-white dark:bg-neutral-900 border-b border-neutral-200 dark:border-neutral-800 sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex flex-wrap items-center gap-3">
            ...
            {/* Passage Filter */}
            {availableFilters?.passageNumbers && availableFilters.passageNumbers.length > 0 && (
              <div className="flex items-center gap-2">
            ...
            <AnimatePresence mode="popLayout">
              {practices.map((practice, index) => {
                ...
                return (
                  ...
                  >
                    <Link href={`/dashboard/practice/reading/${practice.uuid}`}>
                      <div className={cn(
